    ...
    const response = await axios.post(
      ...
      },
      {
        headers: {
          ...
          "Authorization": `Bearer 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`,
        },
      }
    );
...
<div style={{ textAlign: 'center',paddingTop:"50px" }}>
       <form  onSubmit={handleSubmit}>
        <input type="text" value={inputValue} placeholder='Type any Questions..Created by Pon♥Guru' onChange={handleChange} style={{height:"30px", width: '40%',fontSize:"20px", }}/>
